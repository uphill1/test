...
void main(){
  ...
  for(int i=0;i<10;i++){
    aList[i].setAvg();
    print(aList[i].name.padLeft(4)+ aList[i].kor.toString().padLeft(5)+aList[i].eng.toString().padLeft(5)+aList[i].math.toString().padLeft(5)+aList[i].avg.toStringAsFixed(2).padLeft(8));
    print("평균으로 정렬");
    print(strTable + " 비고");
  }
